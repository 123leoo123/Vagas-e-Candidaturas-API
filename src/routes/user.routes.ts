...
import { isEmailAlreadyRegistered } from "../middleware/isEmailAlreadyRegistered";
...
userRoutes.post("/", isEmailAlreadyRegistered.execute, ValidateBody.execute(userRegisterBodySchema), (req, res) => 
